  ...
  return (
    <motion.div layout className="mb-4">
      <form action={sendMessage} ref={ref}>
        <div className="mt-2 grid w-full grid-cols-6 items-center justify-items-center rounded-3xl bg-background-text">
        {isAuthenticated?<PanelDrawer /> :null}
          ...
          <Popup
            ...
            position="top center"
          >
            <div className="flex mb-4 py-3 px-4 h-full w-full flex-col content-stretch items-center justify-items-center rounded-2xl bg-background-text">
              {!userInfo.data ? (
                <button
                  type="button"
